# 🥸 Funny Dad Joke Printer

A retro dot-matrix printer simulator for dad jokes built with React, Vite, and Tailwind CSS.

➡️ [**Live Demo**](https://dadjokes.funnyapps.directory/)
